...
<p align="center">
    <a target="_blank" href="https://search.maven.org/artifact/cn.hutool.v7/hutool-all">
        <img alt="" src="https://img.shields.io/maven-central/v/cn.hutool.v7/hutool-all.svg?label=Maven%20Central" />
    </a>
    ...
    <a href="https://codecov.io/gh/dromara/hutool">
        <img alt="" src="https://codecov.io/gh/dromara/hutool/branch/v7-master/graph/badge.svg" />
    </a>
...
下载整个项目源码（v7-master或v7-dev分支都可）然后进入Hutool项目目录执行：
