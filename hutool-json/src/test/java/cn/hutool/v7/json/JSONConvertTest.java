...
import cn.hutool.v7.json.test.bean.ExamInfoDict;
import cn.hutool.v7.json.test.bean.PerfectEvaluationProductResVo;
import cn.hutool.v7.json.test.bean.UserInfoDict;
