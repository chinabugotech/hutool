...
import cn.hutool.v7.core.convert.BasicType;
...
public class ClassUtil {
	...
	/**
	 * 获取完整类名的短格式如：<br>
	 * text.cn.hutool.v7.core.StrUtil -》c.h.c.u.StrUtil
	 *
	 * @param className 类名
	 * @return 短格式类名
	 * @since 4.1.9
	 ...
	 * 获得给定类所在包的名称<br>
	 * 例如：<br>
	 * cn.hutool.v7.core.reflect.core.ClassUtil =》 cn.hutool.v7.core.reflect
	 *
	 * @param clazz 类
	 * @return 包名
	 */
