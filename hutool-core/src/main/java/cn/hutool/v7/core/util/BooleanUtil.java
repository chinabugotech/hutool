...
public class BooleanUtil {
	...
	/** 表示为真的字符串 */
	private static final Set<String> TRUE_SET = SetUtil.of("true", "yes", "y", "t", "ok", "correct", "success", "on", "1", "是", "对", "真", "對", "正确", "开", "开启", "√", "☑");
	/** 表示为假的字符串 */
	private static final Set<String> FALSE_SET = SetUtil.of("false", "no", "n", "f", "wrong", "fail", "off", "0", "否", "错", "假", "錯", "错误", "关", "关闭", "×", "☒");
