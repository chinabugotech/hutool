...
import cn.hutool.v7.core.io.resource.FileObjectResource;
import cn.hutool.v7.core.classloader.ResourceClassLoader;
...
class JavaClassFileManager extends ForwardingJavaFileManager<JavaFileManager> {
	...
	protected JavaClassFileManager(ClassLoader parent, JavaFileManager fileManager) {
		super(fileManager);
		this.parent = Optional.ofNullable( parent).orElseGet(ClassLoaderUtil::getClassLoader);
	}
