...
public class MethodAnnotationScannerTest {
	...
	public void supportTest() {
		final AnnotationScanner scanner = new MethodAnnotationScanner();
		assertTrue(scanner.support(MethodUtil.getMethod(Example.class, "test")));
	...
	public void getAnnotationsTest() {
		...
		final Method method = MethodUtil.getMethod(Example.class, "test");
