...
public class ClassLoaderUtilTest {
	...
	public void loadInnerClassTest() {
		String name = ClassLoaderUtil.loadClass("cn.hutool.v7.core.classloader.ClassLoaderUtilTest.A").getName();
		Assertions.assertEquals("cn.hutool.v7.core.classloader.ClassLoaderUtilTest$A", name);
		name = ClassLoaderUtil.loadClass("cn.hutool.v7.core.classloader.ClassLoaderUtilTest.A.B").getName();
		Assertions.assertEquals("cn.hutool.v7.core.classloader.ClassLoaderUtilTest$A$B", name);
	}
